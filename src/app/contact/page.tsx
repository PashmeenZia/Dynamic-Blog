...
export default function Contact() {
  ...
  <div className="container px-5 py-2 mx-auto">
    <div className="flex flex-col text-center mx-auto">
      <h1 className=" title-font sm:text-4xl text-5xl mb-2 font-bold font-serif animate-color-change">
        <span className=" px-5 py-2">Contact Us</span></h1>
       <p className="lg:w--2/3 mx-auto leading-relaxed text-gray-900 text-base py-10">Fill the form below for any queries</p>
    </div>
